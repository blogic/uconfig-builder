...
export const PAGE_DESCRIPTIONS: Record<string, string> = {
  ...
  state: 'What the device is doing right now: how long it has been up, what it is running, and how hard it is working.',
  ...
  logs: 'What the device and its kernel have written down, in their own words. Both are held in memory and start fresh when it restarts.',
  memory: 'How much memory and flash the device has left, where the memory has gone, and which processes have grown since it last started watching them.',
